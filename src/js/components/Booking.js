...
export class Booking{
  ...
  updateDOM(){
    ...
    thisBooking.tableBookedId = null;
  ...
  selectTable() {
    ...
    for(let table of thisBooking.dom.tables) {
      ...
      table.addEventListener('click', function() {
        ...
        if (!tableBooked){
          table.classList.add(classNames.booking.tableBooked);
          thisBooking.tableBookedId = parseInt(tableId);
        }
  ...
  SliderColour(){
    ...
    thisBooking.dom.rangeSlider = thisBooking.dom.wrapper.querySelector(
      select.widgets.hourPicker.slider //zapytać o slider!!!!!
    );
    const sliderColours = [];
  ...
  sendReservation(){
    ...
    const payload = {
      ...
      table: thisBooking.tableBookedId,
